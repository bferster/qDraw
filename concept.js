...
function QConcept(dockSide, dockPos, parent)									// CONSTRUCTOR
{
	...
	var ops={id:"QConcept",x:330,y:334,wid:150,ang:45,slices:[]};
...
QConcept.prototype.DrawMenu=function()											// SHOW DRAWING TOOL MENU
{
...
QConcept.prototype.HandleMessage=function(msg)									// REACT TO DRAW EVENT
{
	var vv,v=msg.split("|");													// Split into parts
	if ((v[1] == "QConcept") && (v[0] == "click")) {								// A click in main menu
...
QConcept.prototype.Settings=function()											// SETTINGS MENU
{
	var _this=this;																// Save context
...
QConcept.prototype.ShowInfoBox=function(setting)								// SHOW/HIDE INFO BOX
{
	var str;
...
QConcept.prototype.Do=function(useTempData)									// SAVE DRAWING IN SESSION STORAGE
{
	var o={};
...
QConcept.prototype.UnDo=function()												// GET DRAWING FROM SESSION STORAGE
{
	var o={};
...
QConcept.prototype.ReDo=function()												// REDO DRAWING FROM UNDO
{
...
QConcept.prototype.SetUndoStatus=function()									// SET UNDO/REDO ICONS
{
	$("#sliceicon5").css("opacity",(this.curUndo > 1) ? 1 : .33);
	$("#sliceicon4").css("opacity",(this.curRedo > 0) ? 1 : .33);
}

QConcept.prototype.ClipboardCut=function()										// CLIPBOARD CUT
{
	this.Do();																	// Save undo
...
QConcept.prototype.ClipboardCopy=function()									// CLIPBOARD COPY
{
	var i;
...
QConcept.prototype.ClipboardPaste=function()									// CLIPBOARD PASTE
{
	var i;
	this.Do();																	// Save undo
...
QConcept.prototype.onKeyUp=function(e)											// KEY UP HANDLER
{
...
QConcept.prototype.onKeyDown=function(e)										// KEY DOWN HANDLER
{
...
QConcept.prototype.StyleSelectedSegs=function()							// STYLE SELECTED SEGS
{
	var i,s;
...
function Gdrive()															// CONSTRUCTOR
{
	...
	this.folderName="QConceptings";												// Name of drawings folder
...
QConcept.prototype.SetCookie=function(cname, cvalue, exdays)				// SET COOKIE
{
	var d=new Date();
...
QConcept.prototype.GetCookie=function(cname) {								// GET COOKIE
	var name=cname+"=",c;
...
QConcept.prototype.GetTextBox=function (title, content, def, callback)		// GET TEXT LINE BOX
{
...
QConcept.prototype.Dialog=function (title, content, width, callback, callback2) // DIALOG BOX
{
...
QConcept.prototype.ConfirmBox=function(content, callback)					// CONFIRMATION BOX
{
